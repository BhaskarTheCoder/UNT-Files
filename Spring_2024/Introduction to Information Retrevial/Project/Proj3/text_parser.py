...
# Read input file
with open("/Users/udaybhaskarvalapadasu/Library/Mobile Documents/com~apple~CloudDocs/S-2024/Introduction to Information Retrevial/Project/Proj3/ft911/ft911_1", 'r') as f:
    input_data = f.read()
