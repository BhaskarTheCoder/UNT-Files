...
with open('/Users/udaybhaskarvalapadasu/Library/Mobile Documents/com~apple~CloudDocs/S-2024/Introduction to Information Retrevial/Project/Proj3/stopwordlist.txt', 'r') as f:
    stopwords = f.read().splitlines()

# Read input files
for i in range(1, 469):
    with open(f'/Users/udaybhaskarvalapadasu/Library/Mobile Documents/com~apple~CloudDocs/S-2024/Introduction to Information Retrevial/Project/Proj3/ft911/ft911_1', 'r') as f:
        input_data = f.read()
...
with open('forwardIndex.txt', 'w') as f:
